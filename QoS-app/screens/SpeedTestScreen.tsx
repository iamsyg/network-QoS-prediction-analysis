      ...
      <View style={styles.infoContainer}>
        ...
        <View style={styles.networkInfo}>
          <View style={styles.networkItem}>
            <Text style={styles.networkLabel}>Provider</Text>
            <Text style={styles.networkValue}>Jio</Text>
          </View>
          <View style={styles.networkItem}>
            <Text style={styles.networkLabel}>Technology</Text>
            <Text style={styles.networkValue}>5G</Text>
          </View>
          <View style={styles.networkItem}>
            <Text style={styles.networkLabel}>Signal Quality</Text>
            <Text style={styles.networkValue}>Excellent</Text>
          </View>
        </View>
      </View>
    </View>
